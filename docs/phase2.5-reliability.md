...
Phase 2.6 completed that bounded follow-up. It recovered the development set to 99.588% critical accuracy, then failed the once-run 50-document holdout at 51.815%. See [the Phase 2.6 pilot exit report](phase2.6-pilot-exit.md). The Phase 2.5 figures above remain historical and unchanged.
